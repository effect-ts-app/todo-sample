...
import Balance from "@mui/material-icons/AccountBalance"
import CalendarToday from "@mui/material-icons/CalendarToday"
import Calendar from "@mui/material-icons/CalendarViewMonth"
import Home from "@mui/material-icons/Home"
import Star from "@mui/material-icons/Star"
                ...
                <Draggable key={idx} draggableId={l.id} index={idx}>
                  {(provided) => (
                    ...
                    >
                      <TaskListEntry
                        {...l}
                        title={("| -- " + l.title) as MO.ReasonableString}
                      />
                    </Box>
                  )}
                </Draggable>
